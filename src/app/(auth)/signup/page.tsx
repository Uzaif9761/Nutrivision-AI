...
import { Apple, Mail, Lock, User, ArrowRight, Eye, EyeOff } from "lucide-react";
...
export default function SignupPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6" style={{ background: "var(--gradient-hero)" }}>
        <div className="glass-card p-10 max-w-md text-center">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#11998e] to-[#38ef7d] flex items-center justify-center mx-auto mb-5">
            <Mail className="w-8 h-8 text-[#050a0e]" />
          </div>
  ...
  return (
    ...
    >
      <div className="absolute w-[400px] h-[400px] -top-20 -right-20 rounded-full bg-[radial-gradient(circle,rgba(56,239,125,0.06)_0%,transparent_70%)] float" />
      <div className="absolute w-[300px] h-[300px] -bottom-20 -left-20 rounded-full bg-[radial-gradient(circle,rgba(17,153,142,0.08)_0%,transparent_70%)] float" style={{ animationDelay: "3s" }} />
